...
namespace Microsoft.MixedReality.Toolkit.UI
{
    ...
    /// or BoundsControl
    /// </summary>
    public class CustomRotationAxisConstrain : TransformConstraint
    {
        #region Properties
        ...
        public override void ApplyConstraint(ref MixedRealityTransform transform)
        {
            ...
            eulers.x = Mathf.Clamp(eulers.x % 360, Min.x, Max.x);
            eulers.y = Mathf.Clamp(eulers.y % 360, Min.y, Max.y);
            eulers.z = Mathf.Clamp(eulers.z % 360, Min.z, Max.z);
